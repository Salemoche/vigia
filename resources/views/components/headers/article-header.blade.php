<header class="flex flex-col items-center justify-center flex-wrap">
  ...
  <div class="text-center basis-full mb-5">
    ...
    <span>{{ __( 'von', 'vigia' ) }} </span><a href="#author" class="scroll-to-author text-black no-underline vigia-after-arrow vigia-after-arrow-down after:mr-2.5">{{ the_field('author') }}</a>
  </div>
